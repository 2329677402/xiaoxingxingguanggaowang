...
<style>
   #textStyle{
      font-family:宋体;font-size:16px;color:blue
   }
</style>
...
<HTML>
<center>
   <body bgcolor=pink><p id=textStyle>
</p><br><%=play.logname%>的广告：<br>
<image src =image/<jsp:getProperty name="play" property="showImage"/> width=300 height=200></image><br>
